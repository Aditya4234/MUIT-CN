    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          borderRight: "1px solid rgba(133, 173, 255, 0.05)",
        }}
      >
        {/* Header — Luminous brand anchor */}
        <div className="px-5 pt-8 pb-6 bg-transparent relative overflow-hidden">
          <div
            className="absolute -top-10 -left-10 w-32 h-32 rounded-full blur-[60px] opacity-20"
        ...
        <div className="px-4 pb-5">
          ...
          >
            <Search
              size={15}
              style={{ color: "var(--on-surface-muted)", opacity: 0.6 }}
              className="group-focus-within:text-[#85adff] transition-colors"
            />
            <input
              type="text"
              value={query}
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-6 space-y-1 scrollbar-hide">
                ...
                >
                  ...
                  >
                    {Icon && (
                      <Icon
                        ...
                        style={{
                          color: iconColor,
                          filter: isActive ? `drop-shadow(0 0 8px ${iconColor}60)` : "none",
                        }}
                      />
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      >
                        {formatDistance(dist)} <span className="opacity-40">·</span>{" "}
          ...
          {isSearching && finalList.length === 0 && (
            ...
            >
              <p
                className="text-xs tracking-wide opacity-30"
                style={{ fontFamily: "var(--font-inter)" }}
              >
                No campus coordinates match
                <br />
                &quot;{query}&quot;
              </p>
            </motion.div>
        ...
        {/* Footer */}
        <div
          className="px-6 py-5 mt-auto relative space-y-3"
          style={{ borderTop: "1px solid rgba(133, 173, 255, 0.05)" }}
        >
          <AuthControls />
